...
exports.TdDataTableComponent = __decorate$19([
    _angular_core.Component({
        ...
        styles: [".mat-table-container { display: block; max-width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch; } table.td-data-table.mat-selectable tbody > tr.td-data-table-row { transition: background-color 0.2s; } table.td-data-table.mat-selectable td.td-data-table-cell:first-child, table.td-data-table.mat-selectable th.td-data-table-column:first-child { width: 20px; padding: 0 24px; } [dir='ltr'] table.td-data-table.mat-selectable td.td-data-table-cell:nth-child(2), [dir='ltr'] table.td-data-table.mat-selectable th.td-data-table-column:nth-child(2) { padding-left: 0px; } [dir='rtl'] table.td-data-table.mat-selectable td.td-data-table-cell:nth-child(2), [dir='rtl'] table.td-data-table.mat-selectable th.td-data-table-column:nth-child(2) { padding-right: 0px; } table.td-data-table td.mat-checkbox-cell, table.td-data-table th.mat-checkbox-column { width: 18px; font-size: 0 !important; } table.td-data-table td.mat-checkbox-cell md-pseudo-checkbox, table.td-data-table th.mat-checkbox-column md-pseudo-checkbox { width: 18px; height: 18px; } /deep/ table.td-data-table td.mat-checkbox-cell md-pseudo-checkbox.mat-pseudo-checkbox-checked::after, /deep/ table.td-data-table th.mat-checkbox-column md-pseudo-checkbox.mat-pseudo-checkbox-checked::after { top: 3px !important; width: 11px !important; height: 4px !important; } [dir='ltr'] /deep/ table.td-data-table td.mat-checkbox-cell md-pseudo-checkbox.mat-pseudo-checkbox-checked::after, [dir='ltr'] /deep/ table.td-data-table th.mat-checkbox-column md-pseudo-checkbox.mat-pseudo-checkbox-checked::after { left: 1px !important; } [dir='rtl'] /deep/ table.td-data-table td.mat-checkbox-cell md-pseudo-checkbox.mat-pseudo-checkbox-checked::after, [dir='rtl'] /deep/ table.td-data-table th.mat-checkbox-column md-pseudo-checkbox.mat-pseudo-checkbox-checked::after { right: 1px !important; } table.td-data-table td.mat-checkbox-cell md-checkbox /deep/ .mat-checkbox-inner-container, table.td-data-table th.mat-checkbox-column md-checkbox /deep/ .mat-checkbox-inner-container { width: 18px; height: 18px; margin: 0; } "],
...
exports.TdDataTableColumnComponent = __decorate$21([
    _angular_core.Component({
        ...
        styles: ["/** * Mixin that creates a new stacking context. * see https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Positioning/Understanding_z_index/The_stacking_context */ :host { font-size: 12px; font-weight: bold; white-space: nowrap; padding: 0 28px 0 28px; position: relative; vertical-align: middle; text-align: left; } [dir='ltr'] :host:first-child { padding-left: 24px; } [dir='rtl'] :host:first-child { padding-right: 24px; } [dir='ltr'] :host:last-child { padding-right: 24px; } [dir='rtl'] :host:last-child { padding-left: 24px; } :host md-icon { height: 16px; width: 16px; font-size: 16px !important; line-height: 16px !important; } :host md-icon.td-data-table-sort-icon { opacity: 0; transition: transform 0.25s, opacity 0.25s; } :host md-icon.td-data-table-sort-icon.mat-asc { transform: rotate(0deg); } :host md-icon.td-data-table-sort-icon.mat-desc { transform: rotate(180deg); } :host:hover.mat-sortable md-icon.td-data-table-sort-icon, :host.mat-active.mat-sortable md-icon.td-data-table-sort-icon { opacity: 1; } html[dir=rtl] :host { text-align: right; unicode-bidi: embed; } body[dir=rtl] :host { text-align: right; unicode-bidi: embed; } [dir=rtl] :host { text-align: right; unicode-bidi: embed; } :host bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } :host bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } :host > * { vertical-align: middle; } :host.mat-clickable { cursor: pointer; } :host.mat-clickable:focus { outline: none; } :host md-icon.td-data-table-sort-icon { position: absolute; } :host.mat-numeric { text-align: right; } html[dir=rtl] :host.mat-numeric { text-align: left; unicode-bidi: embed; } body[dir=rtl] :host.mat-numeric { text-align: left; unicode-bidi: embed; } [dir=rtl] :host.mat-numeric { text-align: left; unicode-bidi: embed; } :host.mat-numeric bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } :host.mat-numeric bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } [dir='ltr'] :host.mat-numeric md-icon.td-data-table-sort-icon { margin-left: -22px; } [dir='rtl'] :host.mat-numeric md-icon.td-data-table-sort-icon { margin-right: -22px; } [dir='ltr'] :host:not(.mat-numeric) md-icon.td-data-table-sort-icon { margin-left: 6px; } [dir='rtl'] :host:not(.mat-numeric) md-icon.td-data-table-sort-icon { margin-right: 6px; } "],
...
exports.TdDataTableCellComponent = __decorate$22([
    _angular_core.Component({
        ...
        styles: ["/** * Mixin that creates a new stacking context. * see https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Positioning/Understanding_z_index/The_stacking_context */ :host { font-size: 13px; vertical-align: middle; text-align: left; padding: 0 28px 0 28px; } html[dir=rtl] :host { text-align: right; unicode-bidi: embed; } body[dir=rtl] :host { text-align: right; unicode-bidi: embed; } [dir=rtl] :host { text-align: right; unicode-bidi: embed; } :host bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } :host bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } [dir='ltr'] :host:first-child { padding-left: 24px; } [dir='rtl'] :host:first-child { padding-right: 24px; } [dir='ltr'] :host:last-child { padding-right: 24px; } [dir='rtl'] :host:last-child { padding-left: 24px; } :host > * { vertical-align: middle; } :host.mat-clickable { cursor: pointer; } :host.mat-clickable:focus { outline: none; } :host.mat-numeric { text-align: right; } html[dir=rtl] :host.mat-numeric { text-align: left; unicode-bidi: embed; } body[dir=rtl] :host.mat-numeric { text-align: left; unicode-bidi: embed; } [dir=rtl] :host.mat-numeric { text-align: left; unicode-bidi: embed; } :host.mat-numeric bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } :host.mat-numeric bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } "],
...
exports.TdLayoutNavListComponent = __decorate$45([
    _angular_core.Component({
        ...
        styles: [":host { display: flex; margin: 0; width: 100%; min-height: 100%; height: 100%; overflow: hidden; } :host md-sidenav-container.td-layout-nav-list > md-sidenav.mat-sidenav-opened, :host md-sidenav-container.td-layout-nav-list > md-sidenav.mat-sidenav-opening, :host md-sidenav-container.td-layout-nav-list > md-sidenav.mat-sidenav-closed, :host md-sidenav-container.td-layout-nav-list > md-sidenav.mat-sidenav-closing { box-shadow: none; } [dir='ltr'] :host .td-menu-button { margin-left: 0px; } [dir='rtl'] :host .td-menu-button { margin-right: 0px; } :host .list { text-align: start; } :host /deep/ md-sidenav-container.td-layout-nav-list { /* Ensure the left sidenav is a flex column & 100% height */ } :host /deep/ md-sidenav-container.td-layout-nav-list > .mat-sidenav-content { flex-grow: 1; } :host /deep/ md-sidenav-container.td-layout-nav-list > md-sidenav > cdk-focus-trap, :host /deep/ md-sidenav-container.td-layout-nav-list > md-sidenav > cdk-focus-trap > div { box-sizing: border-box; display: -webkit-box; display: -webkit-flex; display: -moz-box; display: -ms-flexbox; display: flex; flex-direction: column; } "],
...
exports.TdNavigationDrawerComponent = __decorate$49([
    ...
    __param$5(0, _angular_core.Inject(_angular_core.forwardRef(function () { return exports.TdLayoutComponent; }))),
    __metadata$32("design:paramtypes", [exports.TdLayoutComponent,
...
exports.TdMenuComponent = __decorate$59([
    _angular_core.Component({
        ...
        styles: [":host { display: block; margin-top: -8px; margin-bottom: -8px; } :host /deep/ [td-menu-header] { padding: 8px; text-align: center; } :host /deep/ md-list a[md-list-item].mat-2-line .mat-list-item-content, :host /deep/ md-list md-list-item.mat-2-line .mat-list-item-content, :host /deep/ md-list[dense] a[md-list-item].mat-2-line .mat-list-item-content, :host /deep/ md-list[dense] md-list-item.mat-2-line .mat-list-item-content, :host /deep/ md-nav-list a[md-list-item].mat-2-line .mat-list-item-content, :host /deep/ md-nav-list md-list-item.mat-2-line .mat-list-item-content, :host /deep/ md-nav-list[dense] a[md-list-item].mat-2-line .mat-list-item-content, :host /deep/ md-nav-list[dense] md-list-item.mat-2-line .mat-list-item-content { height: auto; padding: 8px; } [dir='ltr'] :host /deep/ md-list a[md-list-item].mat-2-line .mat-list-item-content .mat-list-text, [dir='ltr'] :host /deep/ md-list md-list-item.mat-2-line .mat-list-item-content .mat-list-text, [dir='ltr'] :host /deep/ md-list[dense] a[md-list-item].mat-2-line .mat-list-item-content .mat-list-text, [dir='ltr'] :host /deep/ md-list[dense] md-list-item.mat-2-line .mat-list-item-content .mat-list-text, [dir='ltr'] :host /deep/ md-nav-list a[md-list-item].mat-2-line .mat-list-item-content .mat-list-text, [dir='ltr'] :host /deep/ md-nav-list md-list-item.mat-2-line .mat-list-item-content .mat-list-text, [dir='ltr'] :host /deep/ md-nav-list[dense] a[md-list-item].mat-2-line .mat-list-item-content .mat-list-text, [dir='ltr'] :host /deep/ md-nav-list[dense] md-list-item.mat-2-line .mat-list-item-content .mat-list-text { padding-right: 0px; } [dir='rtl'] :host /deep/ md-list a[md-list-item].mat-2-line .mat-list-item-content .mat-list-text, [dir='rtl'] :host /deep/ md-list md-list-item.mat-2-line .mat-list-item-content .mat-list-text, [dir='rtl'] :host /deep/ md-list[dense] a[md-list-item].mat-2-line .mat-list-item-content .mat-list-text, [dir='rtl'] :host /deep/ md-list[dense] md-list-item.mat-2-line .mat-list-item-content .mat-list-text, [dir='rtl'] :host /deep/ md-nav-list a[md-list-item].mat-2-line .mat-list-item-content .mat-list-text, [dir='rtl'] :host /deep/ md-nav-list md-list-item.mat-2-line .mat-list-item-content .mat-list-text, [dir='rtl'] :host /deep/ md-nav-list[dense] a[md-list-item].mat-2-line .mat-list-item-content .mat-list-text, [dir='rtl'] :host /deep/ md-nav-list[dense] md-list-item.mat-2-line .mat-list-item-content .mat-list-text { padding-left: 0px; } :host /deep/ md-list a[md-list-item].mat-2-line .mat-list-item-content [md-line] + [md-line], :host /deep/ md-list md-list-item.mat-2-line .mat-list-item-content [md-line] + [md-line], :host /deep/ md-list[dense] a[md-list-item].mat-2-line .mat-list-item-content [md-line] + [md-line], :host /deep/ md-list[dense] md-list-item.mat-2-line .mat-list-item-content [md-line] + [md-line], :host /deep/ md-nav-list a[md-list-item].mat-2-line .mat-list-item-content [md-line] + [md-line], :host /deep/ md-nav-list md-list-item.mat-2-line .mat-list-item-content [md-line] + [md-line], :host /deep/ md-nav-list[dense] a[md-list-item].mat-2-line .mat-list-item-content [md-line] + [md-line], :host /deep/ md-nav-list[dense] md-list-item.mat-2-line .mat-list-item-content [md-line] + [md-line] { margin-top: 4px; } .td-menu-content { max-height: calc(50vh); overflow-y: auto; } "],
    })
...
exports.TdNotificationCountComponent = __decorate$61([
    _angular_core.Component({
        ...
        styles: ["/** * Mixin that creates a new stacking context. * see https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Positioning/Understanding_z_index/The_stacking_context */ :host { position: relative; display: block; text-align: center; min-width: 40px; height: 40px; } :host.td-notification-hidden { min-width: 0; } .td-notification-count { line-height: 21px; width: 20px; height: 20px; position: absolute; font-size: 10px; font-weight: 600; border-radius: 50%; z-index: 1; } .td-notification-count.td-notification-center-x { margin-left: auto; margin-right: auto; left: 0px; right: 0px; } .td-notification-count.td-notification-center-y { margin-top: auto; margin-bottom: auto; top: 0px; bottom: 0px; } .td-notification-count.td-notification-top { top: 0px; } .td-notification-count.td-notification-bottom { bottom: 0px; } [dir='ltr'] .td-notification-count.td-notification-before { left: 0px; } [dir='rtl'] .td-notification-count.td-notification-before { right: 0px; } [dir='ltr'] .td-notification-count.td-notification-after { right: 0px; } [dir='rtl'] .td-notification-count.td-notification-after { left: 0px; } .td-notification-count.td-notification-no-count { width: 8px; height: 8px; } .td-notification-count.td-notification-no-count.td-notification-top { top: 8px; } .td-notification-count.td-notification-no-count.td-notification-bottom { bottom: 8px; } [dir='ltr'] .td-notification-count.td-notification-no-count.td-notification-before { left: 8px; } [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before { right: 8px; } [dir='ltr'] .td-notification-count.td-notification-no-count.td-notification-after { right: 8px; } [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after { left: 8px; } /deep/ [dir='rtl'] .td-notification-count.td-notification-before { right: 0px; left: auto; } html[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-before { right: auto; unicode-bidi: embed; } body[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-before { right: auto; unicode-bidi: embed; } [dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-before { right: auto; unicode-bidi: embed; } /deep/ [dir='rtl'] .td-notification-count.td-notification-before bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-before bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } html[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-before { left: 0px; unicode-bidi: embed; } body[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-before { left: 0px; unicode-bidi: embed; } [dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-before { left: 0px; unicode-bidi: embed; } /deep/ [dir='rtl'] .td-notification-count.td-notification-before bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-before bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-after { left: 0px; right: auto; } html[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-after { left: auto; unicode-bidi: embed; } body[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-after { left: auto; unicode-bidi: embed; } [dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-after { left: auto; unicode-bidi: embed; } /deep/ [dir='rtl'] .td-notification-count.td-notification-after bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-after bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } html[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-after { right: 0px; unicode-bidi: embed; } body[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-after { right: 0px; unicode-bidi: embed; } [dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-after { right: 0px; unicode-bidi: embed; } /deep/ [dir='rtl'] .td-notification-count.td-notification-after bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-after bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before { right: 8px; left: auto; } html[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before { right: auto; unicode-bidi: embed; } body[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before { right: auto; unicode-bidi: embed; } [dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before { right: auto; unicode-bidi: embed; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } html[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before { left: 8px; unicode-bidi: embed; } body[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before { left: 8px; unicode-bidi: embed; } [dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before { left: 8px; unicode-bidi: embed; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-before bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after { left: 8px; right: auto; } html[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after { left: auto; unicode-bidi: embed; } body[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after { left: auto; unicode-bidi: embed; } [dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after { left: auto; unicode-bidi: embed; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } html[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after { right: 8px; unicode-bidi: embed; } body[dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after { right: 8px; unicode-bidi: embed; } [dir=rtl] /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after { right: 8px; unicode-bidi: embed; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after bdo[dir=rtl] { direction: rtl; unicode-bidi: bidi-override; } /deep/ [dir='rtl'] .td-notification-count.td-notification-no-count.td-notification-after bdo[dir=ltr] { direction: ltr; unicode-bidi: bidi-override; } .td-notification-content, .td-notification-content /deep/ > * { line-height: 40px; } "],
...
exports.TdSearchInputComponent = __decorate$65([
    _angular_core.Component({
        ...
        styles: [".td-search-input { height: 64px; overflow: hidden; } .td-search-input /deep/ md-input-container.mat-hide-underline .mat-input-underline { display: none; } "],
        animations: [
