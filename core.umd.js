...
exports.TdChipsComponent = __decorate$15([
    _angular_core.Component({
        ...
        selector: 'td-chips',
        styles: [":host { display: block; padding: 0px 5px 0px 5px; } :host /deep/ .td-chip { display: inline-block; cursor: default; border-radius: 16px; line-height: 32px; margin: 8px 8px 0 0; padding: 0 12px; box-sizing: border-box; max-width: 100%; position: relative; } :host /deep/ .td-chip md-icon { position: relative; top: 5px; left: 5px; height: 18px; width: 18px; font-size: 19px; } :host /deep/ .td-chip md-icon:hover { cursor: pointer; } .md-input-underline { position: relative; height: 1px; width: 100%; margin-top: 4px; } .md-input-underline.md-disabled { border-top: 0; background-position: 0; background-size: 4px 1px; background-repeat: repeat-x; } .md-input-underline .md-input-ripple { position: absolute; height: 2px; z-index: 1; top: -1px; width: 100%; transform-origin: top; opacity: 0; transform: scaleY(0); } .md-input-underline .md-input-ripple.md-warn { opacity: 1; transform: scaleY(1); } .md-input-underline .md-input-ripple.md-focused { opacity: 1; transform: scaleY(1); } :host /deep/ md-input input::-webkit-calendar-picker-indicator { display: none; } :host /deep/ md-input .md-input-underline { display: none; } "],
        template: "<div flex> <template let-chip ngFor [ngForOf]=\"value\"> <td-chip> <span>{{chip}}</span> <md-icon *ngIf=\"!readOnly\" [tabIndex]=\"0\"  (keydown.enter)=\"removeItem(chip)\"  (click)=\"removeItem(chip)\" title=\"Delete\">cancel</md-icon> </td-chip> </template> <td-autocomplete #autocomplete  [disabled]=\"readOnly\"  [searchItems]=\"filteredItems\" [placeholder]=\"readOnly? '' : placeholder\" (focus)=\"handleFocus()\" (blur)=\"handleBlur() && (matches = autocomplete.clear())\" (itemSelect)=\"(matches = addItem($event)) && autocomplete.clear()\"></td-autocomplete> <div class=\"md-input-underline\" [class.md-disabled]=\"readOnly\"> <span class=\"md-input-ripple\" [class.md-focused]=\"focused\" [class.md-warn]=\"!matches\"></span> </div> </div> ",
    })
...
exports.TdLayoutComponent = __decorate$42([
    _angular_core.Component({
        selector: 'td-layout',
        styles: [":host { display: flex; margin: 0; width: 100%; min-height: 100%; height: 100%; overflow: hidden; } :host /deep/ > md-sidenav-container > md-sidenav > .md-sidenav-focus-trap > .cdk-focus-trap-content { display: -webkit-box; display: -webkit-flex; display: -moz-box; display: -ms-flexbox; display: flex; flex-direction: column; } "],
...
exports.TdLayoutNavComponent = __decorate$43([
    _angular_core.Component({
        ...
        template: "<div layout=\"column\" layout-fill> <md-toolbar [color]=\"color\"> <button md-icon-button class=\"td-menu-button\" *ngIf=\"isMainSidenavAvailable\" (click)=\"openMainSidenav()\"> <md-icon class=\"md-24\">menu</md-icon> </button> <md-icon *ngIf=\"icon\">{{icon}}</md-icon> <md-icon *ngIf=\"logo && !icon\" class=\"md-icon-logo\" [svgIcon]=\"logo\"></md-icon> <span *ngIf=\"toolbarTitle\">{{toolbarTitle}}</span> <ng-content select=\"[toolbar-content], [td-toolbar-content]\"></ng-content> </md-toolbar> <div flex layout=\"column\" class=\"content md-content\"> <ng-content></ng-content> </div> <ng-content select=\"td-layout-footer\"></ng-content> </div> ",
    }),
...
TdLoadingComponent = __decorate$51([
    ...
    __metadata$32("design:paramtypes", [_angular_core.ChangeDetectorRef])
], TdLoadingComponent);
...
TdLoadingFactory = __decorate$52([
    _angular_core.Injectable(),
    __metadata$33("design:paramtypes", [_angular_core.ComponentFactoryResolver,
...
var TdLoadingDirectiveConfig = (function (_super) {
    __extends$2(TdLoadingDirectiveConfig, _super);
...
exports.TdLoadingService = __decorate$50([
    _angular_core.Injectable(),
    __metadata$31("design:paramtypes", [TdLoadingFactory])
...
__decorate$56([
    ...
    __metadata$36("design:paramtypes", [Array])
...
exports.TdMediaToggleDirective = __decorate$56([
    ...
    __metadata$36("design:paramtypes", [_angular_core.Renderer, _angular_core.ElementRef, exports.TdMediaService])
...
exports.TdNotificationCountComponent = __decorate$60([
    _angular_core.Component({
        ...
        template: "<div #content class=\"td-notification-content\"> <ng-content></ng-content> </div> <div *ngIf=\"show\" class=\"td-notification-count md-{{color}}\" [class.td-notification-top]=\"positionY === 'top'\" [class.td-notification-bottom]=\"positionY === 'bottom'\" [class.td-notification-before]=\"positionX === 'before'\" [class.td-notification-after]=\"positionX === 'after'\" [class.td-notification-center-y]=\"positionY === 'center'\" [class.td-notification-center-x]=\"positionX === 'center'\" [class.td-notification-no-count]=\"noCount\"> {{noCount ? '' : notificationsDisplay}} </div>",
        changeDetection: _angular_core.ChangeDetectionStrategy.OnPush,
    })
...
var TdStepLabelDirective = (function (_super) {
    __extends$3(TdStepLabelDirective, _super);
...
var TdStepActionsDirective = (function (_super) {
    __extends$3(TdStepActionsDirective, _super);
...
var TdStepSummaryDirective = (function (_super) {
    __extends$3(TdStepSummaryDirective, _super);
