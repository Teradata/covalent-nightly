 ...
 */
function TdRotateAnimation(anchor, duration, degrees) {
    if (duration === void 0) { duration = 250; }
    if (degrees === void 0) { degrees = 180; }
    return _angular_animations.trigger(anchor, [
        ...
        _angular_animations.transition('0 <=> 1', [
            _angular_animations.animate(duration + 'ms ease-out'),
        ]),
    ]);
}
