import { EventEmitter, Component, ChangeDetectionStrategy, Optional, ChangeDetectorRef, Input, Output, NgModule, Directive, TemplateRef, ViewContainerRef, ElementRef, Renderer2, ViewChildren, ContentChild, HostListener, ViewChild, HostBinding, Host, Inject, Pipe, LOCALE_ID, Injectable, forwardRef, ContentChildren, RendererFactory2, SecurityContext, ComponentFactoryResolver, Injector, SkipSelf, NgZone } from '@angular/core';
