(function (global, factory) {
    ...
    (factory((global.td = global.td || {}, global.td.markdown = global.td.markdown || {}),global.ng.core,global.ng.platformBrowser,global.ng.common));
...
exports.TdMarkdownComponent = (function () {
    ...
    TdMarkdownComponent.prototype._elementFromString = function (markupStr) {
        ...
        div.innerHTML = this._domSanitizer.sanitize(_angular_core.SecurityContext.HTML, markupStr);
        return div;
    };
...
], exports.TdMarkdownComponent.prototype, "content", null);
exports.TdMarkdownComponent = __decorate([
...
exports.CovalentMarkdownModule = CovalentMarkdownModule_1 = (function () {
    function CovalentMarkdownModule() {
    }
    CovalentMarkdownModule.forRoot = function () {
        return {
            ngModule: CovalentMarkdownModule_1,
            providers: [],
        };
    };
    return CovalentMarkdownModule;
}());
exports.CovalentMarkdownModule = CovalentMarkdownModule_1 = __decorate$1([
...
], exports.CovalentMarkdownModule);
var CovalentMarkdownModule_1;
